...
namespace DungeonAdventure.Test
{
    internal class IntegrationTest
    {
        ...
        public void Setup()
        {
            ...
            userRepository.Register(usuario);

            monster = new Monster("Monstruo1", 30, 40, 5);
            ((MonsterRepository)monsterRepository).AddMonster(monster);

            authService = new AuthService(userRepository);
            game = new GameLogic(monsterRepository);
        ...
        {
            var Jugador = new Player("Jugador1", 11, 0, 0); // le paso la salud mínima esperada para ejecutar
            int salud = 1;
            int ataque = 5;
        ...
        {
            var Jugador = new Player("Jugador1", 9, 0, 0); // le paso la salud menor a la mínima esperada para ejecutar
        ...
        public void LogeoyAsignacionPlayerTest()
        {
            ...
            // asigno al usuario con un jugador y sus respectivas estadísticas
